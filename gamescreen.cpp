...
//    }
    ...
    //turnDialogue = new QString(p1.get_location());
...
//    QString turnDialogue = QString::fromStdString(p1.get_playerName());
//    QString turnDialogue = QString::number(p1.get_location());
//    ui ->label ->setText(buyProp);
//    QString buyProp = "Do you want to buy the " + QString::fromStdString(curSpace.get_name()) + " for $" + QString::number(curSpace.get_price()) + "? (y/n)";
//    ui -> label ->setText(buyProp);
}
